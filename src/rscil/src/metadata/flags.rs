...

    {
        ...
        impl TableDecode for $name {
            ...
            fn decode(_: &TableDecodeContext, buffer: &mut Buffer) -> Result<Self, std::io::Error> {
                paste! {
                    let value = flag!(@read buffer $size);
                    Ok(Self::new(value))
                }
            }
        }
...
flag!(
    ...
    /// 
    /// [II.23.1.2]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=275
    AssemblyFlags {
        PUBLIC_KEY = 0x0001,
        RETARGETABLE = 0x0100,
...
flag!(
    ...
    /// 
    /// [II.23.1.4]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=276
    EventAttributes {
        SPECIAL_NAME = 0x0200,
...
flag!(
    ...
    /// 
    /// [II.23.1.5]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=276                                                             |
    FieldAttributes {
...
flag!(
    ...
    ///
    /// [II.23.1.6]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=277
    FileAttributes : u32 {
...
flag!(
    ...
    /// 
    /// [II.23.1.7]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=277
...
flag!(
    ...
    /// 
    /// [II.23.1.8]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=277
    PInvokeAttributes {
        NO_MANGLE = 0x0001,
...
flag!(
    ...
    /// 
    /// [II.23.1.9]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=278
...
flag!(
    ...
    /// 
    /// [II.23.1.10]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=278
    MethodAttributes {
...
flag!(
    ...
    /// 
    /// [II.23.1.11]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=279
...
flag!(
    ...
    /// 
    /// [II.23.1.12]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=279
    /// [§22.13]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=246
...
flag!(
    ...
    /// 
    /// [II.23.1.13]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=279
    ParamAttributes {
        IN = 0x0001,
        OUT = 0x0002,
        OPTIONAL = 0x0010,
...
flag!(
    ...
    /// 
    /// [II.23.1.14]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=280
    PropertyAttributes {
        SPECIAL_NAME = 0x0200,
        RT_SPECIAL_NAME = 0x0400,
        HAS_DEFAULT = 0x1000,
...
flag!(
    ...
    /// 
    /// [II.23.1.15]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=280
    TypeAttributes : u32 {
...
flag!(
    ...
    /// | `IMAGE_FILE_32BIT_MACHINE`     | `0x0100` | Shall be one if and only if [`RuntimeFlags::COMIMAGE_FLAGS_32BITREQUIRED`] is one ([§II.25.3.3.1]) |
    ...
    /// 
    /// [II.25.2.2.1]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=304
    /// [§II.25.3.3.1]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=309
...
flag!(
    ...
    /// 
    /// [II.25.4.1]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=311
    /// [§II.25.4.2]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=311
    ...
    /// [§II.25.4.5]: https://www.ecma-international.org/wp-content/uploads/ECMA-335_6th_edition_june_2012.pdf#page=312
    MethodHeaderType : u8 {
